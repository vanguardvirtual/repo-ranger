...
describe('Repos Service', () => {
  ...
  describe('getReposByUsername', () => {
    ...
    it('should return repos for a valid username', async () => {
      ...
      Username.findOne.mockResolvedValue(mockUsername);
      Repo.find.mockResolvedValue(mockRepos);
  ...
  describe('createRepo', () => {
    it('should create a new repo', async () => {
      ...
      Repo.create.mockResolvedValue(mockRepo);
      const result = await reposService.createRepo(mockRepo);
  ...
  describe('updateRepo', () => {
    it('should update an existing repo', async () => {
      ...
      Repo.update.mockResolvedValue(mockRepo);
      const result = await reposService.updateRepo(mockRepo);
      expect(result).toEqual(mockRepo);
